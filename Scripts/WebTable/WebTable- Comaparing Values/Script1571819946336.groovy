...
String ExpectedValue = 'Matt Barnes '

'To locate table'
WebElement Table = driver.findElement(By.xpath('/html/body/div[1]/div/div/div/div/div[5]/div[2]/div[5]/div[1]/div[1]/section/div/section/div[2]/div[1]/section/div[2]/div/div[2]/table'))
    ...
    for (int j = 0; j < columns_count; j++) {
        ...
        if (Value == false) {
            ...
            if (celltext == ExpectedValue) {
                'Getting the 4th Player of the team if cell text i.e Starting Player matches with Expected value'
                String PlayerName = Columns_row.get(4).getText()

                println('Text present in row number 3 is: ' + PlayerName)
